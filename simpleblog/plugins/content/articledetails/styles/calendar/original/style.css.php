...
<?php if ($shadow_width > 0) : ?>
	.articledetails .info {
		margin-top: <?php echo $shadow_width; ?>px;
	}
<?php endif; ?>
...
.articledetails .head {}
	...
	.articledetails .head .calendar.noimage {
		...
		.articledetails .head .calendar.noimage .position1 {
			...
			<?php if ($border_width == 0 && $border_radius > 0) : ?>
				border-top-right-radius: <?php echo $border_radius; ?>px;
				border-top-left-radius: <?php echo $border_radius; ?>px;
				-moz-border-top-right-radius: <?php echo $border_radius; ?>px;
				-moz-border-top-left-radius: <?php echo $border_radius; ?>px;
				-webkit-border-top-right-radius: <?php echo $border_radius; ?>px;
				-webkit-border-top-left-radius: <?php echo $border_radius; ?>px;	
		...
		.articledetails .head .calendar.noimage .position5 {
			...
			<?php if ($border_width == 0 && $border_radius > 0) : ?>
				...
				-moz-border-bottom-right-radius: <?php echo $border_radius; ?>px;
				-moz-border-bottom-left-radius: <?php echo $border_radius; ?>px;
