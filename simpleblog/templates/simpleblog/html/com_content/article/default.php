...
?>
	...
	<?php if ($canEdit) : ?>
		<?php 
			...
			// $itemId=159;
			// $layout='simpleblog:myarticles';
		?>
		<ul class="icons pull-right nav nav-pills">
			<li> <?php echo JHtml::_('icon.edit', $this->item, $params); ?> </li>
			<li> <?php echo JHTML::_('link','index.php?option=com_content&view=category&id='.$this->item->catid.'&Itemid='
																.$itemId.'&task=delete&aid='.$this->item->id,JText::_('TPL_SIMPLEBLOG_DELETE_BUTTON')); ?> </li>
		</ul>
	<?php endif; ?>
				...
				<?php if ($params->get('show_author') && !empty($this->item->author )) : ?>
					<dd class="createdby" itemprop="author" itemscope itemtype="http://schema.org/Person">
						...
						<?php if (!empty($this->item->contact_link) && $params->get('link_author') == true) : ?>
							<?php echo JText::_('TPL_SIMPLEBLOG_AUTHOR_LABEL').': '.JHtml::_('link', $this->item->contact_link, $author, array('itemprop' => 'url')); ?>
						<?php else: ?>
							<?php echo JText::_('TPL_SIMPLEBLOG_AUTHOR_LABEL').': '.$author; ?>
						<?php endif; ?>
					</dd>
				<?php endif; ?>
